...
class AppTextStyles {
  static const headingTextStyle = TextStyle(fontSize: 32, fontWeight: FontWeight.w700, );
  static const headingTextStyle2 = TextStyle(fontSize: 28, fontWeight: FontWeight.w400,);
  static const headingTextStyle3 = TextStyle(fontSize: 24, fontWeight: FontWeight.w700,);
  static const subHeadingTextStyle = TextStyle(fontSize: 20, fontWeight: FontWeight.w700,);
  static const buttonTextStyle = TextStyle(fontSize: 18, fontWeight: FontWeight.w500,);
  static const regularTextStyle = TextStyle(fontSize: 16, fontWeight: FontWeight.w300,);
