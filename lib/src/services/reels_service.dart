...
class ReelsService {
  ...
  static Future<List<ReelModel>> fetchUserReels({
    required String userId,
    required DocumentSnapshot? lastDoc,
    required int limit,
    required void Function(DocumentSnapshot?) onLastDoc,
  ...
  static Future<List<ReelModel>> fetchUserBookmarkedReels({
    required String userId,
    required DocumentSnapshot? lastDoc,
    required int limit,
    required void Function(DocumentSnapshot?) onLastDoc,
  ...
  static Future<List<ReelModel>> fetchReelsByMood({
  ...
  static Future<List<ReelModel>> fetchMoreReels({
    ...
    List<ReelModel> fetchedReels = [];
    Query query =  FirebaseFirestore.instance.collection(FirebaseConstants.reelsCollection)
        .orderBy('createdAt', descending: true)
        .limit(limit);
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      fetchedReels = querySnapshot.docs.map((doc)=> ReelModel.fromMap(doc.data() as Map<String, dynamic>)).toList();
