    ...
    return Scaffold(
      ...
      body: SafeArea(child: Padding(
        ...
        child: Column(
          ...
          StreamBuilder(
              ...
              builder: (ctx, snapshot){
                if(snapshot.hasData){
                  ...
                  return SettingsItemWidget(title: "Private Account", isSwitch: true, switchValue: isPrivate, onSwitchChange: (val)=> SettingsService.setAccountVisibility(isPrivate: val),);
                }

                return SettingsItemWidget(title: "Private Account", isSwitch: true, onSwitchChange: (val)=>  SettingsService.setAccountVisibility(isPrivate: val),);
              },),
          StreamBuilder(
          ...
          SettingsItemWidget(title: "Who can see your feels"),
            ...
            StreamBuilder(
              ...
              builder: (ctx, snapshot){
                if(snapshot.hasData){
                  ...
                  return SettingsItemWidget(title: "Remember me", isSwitch: true, switchValue: rememberMe, onSwitchChange: (val)=> SettingsService.setAccountVisibility(isPrivate: val),);
                }

                return SettingsItemWidget(title: "Remember me",switchValue: true, isSwitch: true, onSwitchChange: (val)=>  SettingsService.setAccountVisibility(isPrivate: val),);
              },),
        ],),
      )),
    );
