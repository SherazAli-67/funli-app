      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              StreamBuilder(
                  stream: ReelsService.getReelCommentCount(reelID: widget._reelID),
          ...
          StreamBuilder(stream: ReelsService.getReelsComment(reelID: widget._reelID), builder: (ctx, snapshot){
              ...
              return Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (ctx, index){
                    ...
                    return Padding(
                      ...
                      child: CommentItemWidget(comment: comment, reelID: widget._reelID)
                    );
                  }));
            }
            ...
            child: Row(
              children: [
                ...
                IconButton(onPressed: ()async{
                  ...
                  await ReelsService.addCommentToReel(reelID: widget._reelID, commentText: commentText);
